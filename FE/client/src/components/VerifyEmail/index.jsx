  ...
  return (
    <>
      ...
      <CustomModal
        ...
        } text-center text-gray-800 bg-primary shadow-xl lg:max-w-3xl rounded-3xl lg:p-12`}
        isOpen={open}
        onClose={handleClose}
      >
        ...
        <div className="mt-4">
          <div className="relative flex items-center justify-center">
            <Button
              ...
              className={`${
                isSuccess && "hidden"
              } px-4 py-2 text-white hover:opacity-90 active:scale-90 hover:scale-105 transition-transform bg-bluePrimary rounded-xl ${
                isMobile ? "text-sm" : ""
              }`}
            />
            {isSuccess && (
